# DRAFT - Angular Boot Camp Curriculum - route-driven-data-loading
...
[StackBlitz for route-driven-data-loading](https://stackblitz.io/github/AngularBootCamp/route-driven-data-loading)

Alternatively, you can clone the repository locally and run the
following commands:

```
git clone git@github.com:AngularBootCamp/route-driven-data-loading.git
cd route-driven-data-loading
yarn
yarn start
```
