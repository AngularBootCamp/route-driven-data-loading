...
const routes = [
    ...
    {
        path: 'employees',
        loadChildren: () => __webpack_require__.e(/*! import() | employee-employee-module */ "employee-employee-module").then(__webpack_require__.bind(null, /*! ./employee/employee.module */ "./src/app/employee/employee.module.ts")).then(m => m.EmployeeModule)
    }
];
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 10, vars: 0, consts: [[1, "nav-wrapper"], ["routerLinkActive", "green-background"], ["routerLink", "/employees"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
